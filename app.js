...
const simDefs=[
 ['atom','Atomic structure','3.2.1.1'],['specific','Specific charge','3.2.1.1'],['strong','Nuclear force','3.2.1.2'],['decay','Alpha & beta decay','3.2.1.2 / 3.2.1.7'],['antimatter','Antimatter & photons','3.2.1.3'],['interactions','Exchange particles','3.2.1.4'],['classification','Particle families','3.2.1.5'],['quarks','Quark builder','3.2.1.6'],['photo','Photoelectric effect','3.2.2.1'],['collisions','Electron collisions','3.2.2.2'],['levels','Energy levels','3.2.2.3'],['diffraction','Electron diffraction','3.2.2.4'],['rutherford','Rutherford extension','3.8.1.1']
];
